...
class Board:
    ...
    def __init__(self, x_ref, y_ref, board_length):
        ...
        for i in range(8):
            self.pieces.append(Piece(cols[i] + '1'), types[i])
            self.pieces.append(Piece(cols[i] + '2'), 'pawn')
            self.pieces.append(Piece(cols[i] + '7'), 'pawn')
            self.pieces.append(Piece(cols[i] + '8'), types[i])
